...
class TestFunctionRegistration(PrepareDeploymentPlanTestCase):
    def setUp(self):
        ...
        def get_node_instances(node_id=None):
            return [
                NodeInstance(
                    id='webserver1',
                    node_id='webserver',
                    runtime_properties={'attribute': 'attribute_value'})
            ]
